...
def detect_lines_in_roi(frame, roi, canny_threshold1=30, canny_threshold2=163, hough_threshold=20, min_line_length=30, max_line_gap=5):
    x, y, w, h = roi
...
def main():
    ...
    while True:
        ...
        frame = detect_lines_in_roi(frame, roi, canny_threshold1=30, canny_threshold2=163, hough_threshold=20, min_line_length=30, max_line_gap=5)
